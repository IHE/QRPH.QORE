...
* status = #final 
* component:SystolicBP.dataAbsentReason = $8801023 "Unable to Complete"
* component:DiastolicBP.dataAbsentReason = $8801023 "Unable to Complete"
// [Note: NEMSIS Values]
...
* subject = Reference(Patient/ea25ec4c-38bd-11ec-8d3d-0242ac130003)
* dataAbsentReason = $8801023 "Unable to Complete"
// [Note: NEMSIS Values]
* effective[x].effectiveDateTime = "2021-10-06T10:52:03-07:00"
* encounter = Reference(Encounter/8da1a2e0-38c2-11ec-8d3d-0242ac130003)
* method = $7701001 "Not Applicable"
...
* satus = #final
* value[x].valueCodeableConcept = $8801023 "Unable to Complete"
// [Note: NEMSIS Values]
* encounter = Reference(Encounter/8da1a2e0-38c2-11ec-8d3d-0242ac130003)
* effective[x].effectiveDateTime = "2021-10-06T10:52:03-07:00"
* subject = Reference(Patient/ea25ec4c-38bd-11ec-8d3d-0242ac130003)
...
InstanceOf: http://hl7.org/fhir/StructureDefinition/oxygensat
Usage: #inline
* id = e4f5a1b9-d44d-4cb5-8491-16f9c37f3790
* satus = #final
* dataAbsentReason = $8801023 "Unable to Complete"
// [Note: NEMSIS Values]
* encounter = Reference(Encounter/8da1a2e0-38c2-11ec-8d3d-0242ac130003)
