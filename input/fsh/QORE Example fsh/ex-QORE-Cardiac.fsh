Instance: example-QORE-Cardiac 
InstanceOf: Composition
* id = "Quality Outcomes report for EMS"
* status = #final
* type = 
* category = 
* subject = 
...
Instance: example-QORE-Cardiac-Measure-Report 
InstanceOf: MeasureReport
* id = ""
* status = #complete
* type = #individual
* measure = Reference(Measure/63901100-732e-450c-b384-b054a75c83ee)
* evaluatedResource = 
 - eSituation.09 - Primary Symptom = PCS Encounter diagnosis.condition =  ICD 10....
 - eArrest.20 - Who First Initiated CPR = PCS-composition Cardiac arrest event CPR observations = bystander


Instance:   example-IHE_QORE_CPR-1
InstanceOf: Measure
Title: "Example of CPR-1 measure"
Description:      "holding typical values for a Cardiac measure"
* meta.security = http://terminology.hl7.org/CodeSystem/v3-ActReason#HTEST
* id = "63901100-732e-450c-b384-b054a75c83ee"
* identifier = "CPR-1"
...
* population.code [+] = #denominator
* population.description [=] = "All Medical OCHAs in the month"
//Note: PCS Status history sub type = PSAP, status history period. Time 
...
Instance:   example-IHE_QORE_CPR-9
InstanceOf: Measure
...
Instance:   example-IHE_QORE_CPR-10
InstanceOf: Measure
